...
const db = new sqlite3.Database('ConnectingPG.db', sqlite3.OPEN_READWRITE, (dict, err) => {
  ...
  dict = [
    ...
    // will use join to say the alias of house is "name" in the house table, can join
    {
      house: 'Adams',
      year: '2018',
      name: 'Adams Junior Wins Truman Scholarship',
      description: 'Nicholas Whittaker, of the Class of 2019, wins the Truman Scholarship. A philosophy concentrator, Whittaker was one of 59 college students in the United States to be selected for this prestigious award.',
      source: 'https://hollis.harvard.edu/primo-explore/fulldisplay?docid=TN_proquest2024228665&context=PC&vid=HVD2&search_scope=everything&tab=everything&lang=en_US',
    },
    {
      house: 'Cabot',
      month: '09',
      year: '2018',
      name: 'Tutor Leads Political Activism',
      description: 'Cabot House tutor and Law School student Connie Cho organizes a campus walkout against the nomination of Brett Kavanaugh to the U.S. Supreme Court.',
      source: 'https://hollis.harvard.edu/primo-explore/fulldisplay?docid=TN_proquest2112011223&context=PC&vid=HVD2&search_scope=everything&tab=everything&lang=en_US',
    },
    {
      house: 'Currier',
      year: '1980',
      name: 'Neil deGrasse Tyson Graduates',
      description: 'Famous astrophysicist and Currier resident Neil deGrasse Tyson graduates from Harvard.',
      source: 'https://currier.harvard.edu/currier-house-history-0',
    },
    {
      house: 'Dunster',
      month: '12',
      year: '1938',
      name: 'Playwright\'\s First Play',
      description: 'Robert Anderson, a famous playwright and Harvard student, launches his very first play, "Hour Town", in Dunster House.',
      source: 'https://hollis.harvard.edu/primo-explore/fulldisplay?docid=TN_proquest1929346072&context=PC&vid=HVD2&search_scope=everything&tab=everything&lang=en_US',
    },
    {
      house: 'Eliot',
      year: '1991',
      name: 'Eliot Tutor Takes House System to USC',
      description: 'Professor Kevin Starr of USC uses his background in the Residential House system as a senior tutor in Eliot to bring a residential house system to the University of Southern California.',
      source: 'https://hollis.harvard.edu/primo-explore/fulldisplay?docid=TN_proquest291189136&context=PC&vid=HVD2&search_scope=everything&tab=everything&lang=en_US',
    },
    {
      house: 'Kirkland',
      year: '1933',
      name: 'Kirkland Expands',
      description: 'Gregory S. Bryan Hall is added to Kirkland, joining its existing two wings to complete the house\'\s Quadrangle.',
      source: 'https://hollis.harvard.edu/primo-explore/fulldisplay?docid=TN_proquest100736836&context=PC&vid=HVD2&search_scope=everything&tab=everything&lang=en_US',
    },
    {
      house: 'Leverett',
      month: '09',
      year: '2018',
      name: 'Racist Drawings Found',
      description: 'Racist drawings are find inside of Leverett House, receiving swift and strong condemnation from House Faculty Deans and the campus community.',
      source: 'https://hollis.harvard.edu/primo-explore/fulldisplay?docid=TN_proquest2138447946&context=PC&vid=HVD2&search_scope=everything&tab=everything&lang=en_US',
    },
    {
      house: 'Lowell',
      year: '1933',
      name: 'Art Exhibition Held in Lowell',
      description: 'Students organize an art exhibition to be held in Lowell with submissions of all types possible.',
      source: 'http://id.lib.harvard.edu/via/olvwork614476/catalog',
    },
    {
      house: 'Mather',
      year: '2016',
      name: 'Research on Increase Mather',
      description: 'A group of Mather students come together to research the life of Increase Mather for whom the house was named.',
      source: 'https://mather.harvard.edu/about-mather',
    },
    {
      house: 'Pforzheimer',
      year: '1971',
      name: 'Pforzheimer Predecessor Goes Co-Ed',
      description: 'North House, the former Pforzheimer, goes co-ed for the very first time after having been a dorm of the all-female Radcliffe College.',
      source: 'https://pfoho.harvard.edu/pfolklore-and-history',
    },
    {
      house: 'Quincy',
      month: '10',
      year: '2014',
      name: 'Dining Hall Swiper Wins Lottery',
      description: 'Ana Rodriguez, the card-swiper for the Quincy House dining hall, wins $10 million in the Massachusetts lottery. She still works in the Quincy dining hall.',
      source: 'https://www.thecrimson.com/article/2014/10/17/quincy-worker-wins-lottery/',
    },
    {
      house: 'Winthrop',
      year: '2017',
      name: 'Third Consecutive Straus Cup',
      description: 'For the third year in a row, Winthrop House wins the Straus Cup, the intramural sports championship.',
      source: 'https://www.thecrimson.com/article/2017/5/1/winthrop-wins-straus-cup/',
    }
  ];
